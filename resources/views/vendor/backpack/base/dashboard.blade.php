  ...
  <div class="row">
    ...
    <div class="card">
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-sm-6">
                <div class="callout callout-info"><small class="text-muted">All Employees</small><br><strong class="h4">9,123</strong>
                ...
                <!-- /.col-->
                <div class="col-sm-6">
                <div class="callout callout-danger"><small class="text-muted">Staffs</small><br><strong class="h4">22,643</strong>
                    <div class="chart-wrapper">
            ...
            <div class="row">
                <div class="col-sm-6">
                <div class="callout callout-warning"><small class="text-muted">Teachers</small><br><strong class="h4">78,623</strong>
                    <div class="chart-wrapper">
                ...
                <!-- /.col-->
                <div class="col-sm-6">
                <div class="callout callout-success"><small class="text-muted">Interships</small><br><strong class="h4">49,123</strong>
                    <div class="chart-wrapper">
